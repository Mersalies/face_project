...
def take_photo_from_camera_1v(output_folder: str = "camera_photos", file_prefix: str = ""):
    """
...
file_name = 'my_photo'
take_photo_from_camera_1v(output_folder=file_name)


def take_photo_from_camera_2v(output_folder: str = "camera_photos", file_prefix: str = ""):
    """
    Делает фотографию с веб-камеры и сохраняет ее в указанную папку.
